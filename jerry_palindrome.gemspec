...
require "jerry_palindrome/version"

Gem::Specification.new do |spec|
  spec.name          = "jerry_palindrome"
  spec.version       = JerryPalindrome::VERSION
  spec.authors       = ["Jerry Birnbaum"]
  spec.email         = ["jerry@propertymatrix.com"]
